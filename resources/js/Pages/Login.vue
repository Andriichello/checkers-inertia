<template>
  <BaseLayout>
    <div class="flex flex-col justify-center items-center gap-3 mt-4">
      <h3 class="text-3xl font-bold underline">Login page</h3>
      <p class="max-w-sm text-xl font-light px-3">
        This is a login page of the Checkers app, written using
        Laravel and Vue.js with Inertia.js
      </p>

      <div @submit.prevent="onLogin" class="w-full flex justify-center items-center mt-2">
